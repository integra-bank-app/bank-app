...
export default function AddUserToBranchDialog({
    ...
    const validate = () => {
        ...
        if (!firstName.trim()) newErrors.firstName = t("addUserToBranchDialog.errorFirstName");
        if (!lastName.trim()) newErrors.lastName = t("adUserToBranchDialog.errorLastName");
        setErrors(newErrors);
    ...
    return (
        ...
        >
            <div className="flex flex-column gap-3">
                ...
                <Button
                    label={loading ? t("addUserToBranchDialog.addingButton") : t("addUserToBranchDialog.addUserButton")}
                    icon="pi pi-check"
