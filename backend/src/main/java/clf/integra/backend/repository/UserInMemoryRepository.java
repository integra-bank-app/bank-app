...
public class UserInMemoryRepository implements IUserRepository {
    ...
    public UserInMemoryRepository() {
        ...
        this.userRepository.put(user1Id, new User(user1Id, "John", "", "Doe", 1000.55, new Branch()));

        UUID user2Id = UUID.randomUUID();
        this.userRepository.put(user2Id, new User(user2Id, "Andrei", "Mihai", "Popescu", 2500.00, new Branch()));

        UUID user3Id = UUID.randomUUID();
        this.userRepository.put(user3Id, new User(user3Id, "Jane", "", "Smith", 1500.25, new Branch()));
    }
